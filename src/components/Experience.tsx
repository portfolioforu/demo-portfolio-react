  ...
  return (
    <section id="parcours" className="bg-cream-dim/50 px-6 py-24 md:py-32">
      <div className="mx-auto max-w-3xl">
        ...
        <Reveal delay={0.08} className="mt-16 flex flex-col items-start gap-4 rounded-2xl border border-line bg-white p-7 sm:flex-row sm:items-center sm:justify-between">
          <div>
