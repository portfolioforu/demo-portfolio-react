    ...
    <section id="contact" className="px-6 py-24 md:py-32">
      <div className="mx-auto max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4 text-left">
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-line bg-white px-4 py-2.5 text-base text-ink outline-none transition-colors focus:border-coral"
                  placeholder="Ton nom"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-line bg-white px-4 py-2.5 text-base text-ink outline-none transition-colors focus:border-coral"
        ...
        <Reveal delay={0.14} className="mt-16">
          ...
          <div className="mt-4 divide-y divide-line rounded-2xl border border-line bg-white/60">
