        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {projects.map((p, i) => (
            ...
            >
              <Link
                to={`/projets/${p.slug}`}
                className="group relative block h-full overflow-hidden rounded-2xl border border-line bg-white p-7 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-coral/10"
              >
